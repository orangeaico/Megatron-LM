...
if [[ "$TRAINING_MODE" == "cpt" ]]; then
    ...
    TRAIN_DATA_PATH="$BASE_DIR/data/sft/hard_set_with_hints_15_jan/training_data_30b_480b_pr_mirror_only_val_set_weight2_with_hints.jsonl"
