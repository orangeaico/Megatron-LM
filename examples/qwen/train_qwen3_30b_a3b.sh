...
if [[ "$TRAINING_MODE" == "cpt" ]]; then
    ...
    TRAIN_DATA_PATH="$BASE_DIR/data/sft/hard_set_13_dec/loss_mask_training_traj_sft_480b_with_hints_filtered.jsonl"
    VALID_DATA_PATH="$BASE_DIR/data/sft/hard_set_13_dec/loss_mask_training_traj_sft_480b_with_hints_filtered.jsonl"
    TEST_DATA_PATH=$VALID_DATA_PATH 
