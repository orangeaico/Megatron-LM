...
CHECKPOINT_PATH=${1:-"output/$MODEL_NAME/checkpoints/"}
TENSORBOARD_LOGS_PATH=${2:-"output/$MODEL_NAME/tensorboard_logs/"}
TENSORBOARD_LOGS_PATH_MEMORY=${2:-"output/$MODEL_NAME/memory_snapshots/memory_snapshot.pickle"}
TOKENIZER_ARG=${3:-"Qwen/Qwen3-1.7B"} # Path to tokenizer model or HF model name
DATA_ARG=${4:-"/workspace/training/data/_text_document"}     # Data prefix
